...
#'
#' @param id ID for the module
#' @param papermeshtree A papermeshtree data frame
...
#' @export
#'
mod_meshTree_server <- function(id, papermeshtree, conn) {
  ...
  moduleServer(
    ...
    function(input, output, session) {
      ...
      meshfilter <- mod_meshFilter_server("meshfilter", conn)
      ...
      observeEvent(event_data("plotly_click", "mtPlot"), {
